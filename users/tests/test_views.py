...
class UserViewTests(TestCase):
    ...
    def test_register_view(self):
        ...
        self.assertTrue(any(message.message == "Your account was created successfully. Please log in." for message in messages))
    ...
    def test_profile_view(self):
        ...
        self.assertEqual(response.status_code, 200)  # Form error
        messages = list(get_messages(response.wsgi_request))
        self.assertTrue(any(message.message == 'Error updating profile. Please check the form.' for message in messages))
...
class UserAPITests(TestCase):
    ...
    def test_user_update(self):
        ...
        response = self.client.patch(f'/api/v1/users/users/{self.user.id}/', {
            'bio': 'Updated bio'
        })
        self.assertEqual(response.status_code, status.HTTP_200_OK)

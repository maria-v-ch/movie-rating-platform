...
class UserCreateSerializerTests(TestCase):
    ...
    def test_create_user_duplicate_username(self):
        ...
        User.objects.create_user(username="newuser", email="existing@example.com", password="existingpass123")
...
class UserUpdateSerializerTests(TestCase):
    ...
    def test_update_email_valid(self):
        ...
        serializer = UserUpdateSerializer(
            self.user, data={"email": "newemail@example.com"}, context={"request": self.request}
        )
        self.assertTrue(serializer.is_valid())
        user = serializer.save()
    ...
    def test_update_email_duplicate(self):
        ...
        serializer = UserUpdateSerializer(
            self.user, data={"email": "other@example.com"}, context={"request": self.request}
        )
        self.assertFalse(serializer.is_valid())
